    ...
    <div className="row">
      <div className="col-lg-8">
        <div className="main-error mb-3">
          <h2 className="error-code text-dark text-center font-weight-semibold m-0">500 <i className="fas fa-file" /></h2>
          <p className="error-explanation text-center">We are sorry, something went wrong.</p>
        </div>
      </div>
      <div className="col-lg-4">
